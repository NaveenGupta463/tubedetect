...
const NICHE_RULES = [
  ...
  ['finance',      ['mutual fund', 'stock market', 'stock', 'investing', 'stock trading', 'day trading', 'options trading', 'intraday trading', 'forex trading', 'trading strategy', 'trading account', 'trading app', 'trading chart', 'nifty', 'sensex', 'financial planning', 'insurance', 'loan', 'tax planning', 'economic update', 'economy', 'budget', 'cryptocurrency', 'crypto', 'personal finance', 'wealth', 'money management', 'financial advice', 'market analysis', 'economic analysis']],
